...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FourOhFourCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"fourohfourcoin.info", "128.199.249.126"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.fourohfourcoin.info", "testnet.fourohfourcoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FourOhFourCoin is probably already running."), addrBind.ToString().c_str());
        else
